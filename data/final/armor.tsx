...
export const armor: IItem[] = [
  {
    ...
    types: [ItemType.armor, ItemType.unique, ItemType.irreplaceable, ItemType.accessory],
  },
  {
    affinity: {
    ...
    types: [ItemType.armor, ItemType.jewelry, ItemType.accessory],
  },
  {
    affinity: {
      bottom: Affinity.red,
  ...
  {
    desc:
      'Block 2: spend move to ignore 2 hits next time you are attacked (up until your next act). You cannot block more than once per attack. Shield adds +2 armor to all locations.',
    id: 5,
  ...
  {
    desc:
      'The shield has a myriad of eyes on the front to confuse the opponent. If a trap hit location card is drawn during your attacks, discard it and draw another hit location card. 1x/attack. Block 1.',
    id: 6,
  ...
  },
  {
    ...
    types: [0, 8, 11, ItemType.accessory],
  },
  {
    desc: '',
    id: 9,
  ...
  },
  {
    ...
    types: [0, ItemType.set, ItemType.metal],
  },
  {
  ...
  {
    desc:
      '1x 1-aff-blue / 1x 0.5-aff-green / 1x 1-aff-green = Guard: at the end of your attack, if you are standing and have a shield, spend 1 survival to move 3 spaces directly away from monster and Block 1 for free.',
    id: 29,
  ...
  },
  {
    ...
    types: [0, ItemType.mask, ItemType.accessory],
  },
  {
  ...
  },
  {
    ...
    types: [ItemType.armor, ItemType.set, ItemType.leather],
  },
  {
    affinity: {
      right: Affinity.green,
  ...
  },
  {
    ...
    types: [ItemType.item, ItemType.flammable, ItemType.accessory],
  },
  {
    affinity: {
      right: Affinity.green,
    ...
    obtained: 'Catarium',
    stats: [],
    types: [ItemType.armor, ItemType.fur, ItemType.bone, ItemType.heavy, ItemType.flammable],
  },
  {
  ...
  },
  {
    ...
    types: [0, 9, 18, ItemType.accessory],
  },
  {
    affinity: {
      top: Affinity.green,
  ...
  },
  {
    ...
    types: [ItemType.armor, ItemType.set, ItemType.fur],
  },
  {
    affinity: {
      bottom: Affinity.green,
  ...
  },
  {
    ...
    types: [ItemType.armor, ItemType.bone, ItemType.fragile],
  },
  {
  ...
  },
  {
    ...
    types: [ItemType.armor, ItemType.set, ItemType.fur, ItemType.heavy],
  },
  {
