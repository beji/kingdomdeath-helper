...
const innovations: IInnovation[] = [
  {
    id: 0,
    name: `Advanced Combat: Flanking`,
    consequence_of: 19,
    description: `The survivors have learned how to flank opponents in combat for an advantage. Whenever two survivors are directly opposite the monster, and also directly adjacent to the monster, then they both gain +1 accuracy and +1 strength for their attacks.`,
  },
  {
    id: 1,
    name: `Advanced Combat: Shield Wall`,
    consequence_of: 19,
    description: `If two survivors are on the same facing of the monster, and both survivors have shields, then any time the monster attempts to pass over them (collide), the survivors blocking the monster roll 1d10. If each of their rolls is equal or less than their respective strengths, they prevent the monster from passing over them.`,
  },
  {
    id: 2,
    name: `Albedo`,
    consequence_of: 36,
    description: `** Make elixir - once this lantern year, roll 1d10.
  ...
  },
  {
    ...
    name: `Altar`,
    consequence_of: 54,
    description: `Item Sacrifice (no endeavor cost) - Sacrifice (destroy and remove the resources from settlement storage) 3 resources of any type - then roll 1d10:
  ...
  },
  {
    ...
    name: `Arena`,
    consequence_of: 35,
    description: `* Spar - spend 1 iron and roll 1d10:
  ...
  },
  {
    ...
    survival_depart: 1,
    insanity_depart: 1,
    description: `The survivors build a sculpture of faces of the dead to look upon the living. It is unsettling, and changes on its own at the whim of the dead.
  ...
  },
  {
    ...
    name: `Backpack`,
    consequence_of: 24,
    description: `Settlement may craft backpacks at a cost of 3 hide, pelts, or leather per pack. A backpack expands the gear grid for one survivor from 3x3 grids to 4x3 grids (4 columns by 3 rows). The backpack takes no gear grid space itself.`,
  },
  {
    id: 8,
    name: `Backpack Expanded`,
    consequence_of: 7,
    description: `Existing backpacks may be upgraded at a cost of 1 hide, pelt, or leather (per pack upgraded). Add one grid space on a fourth row of that backpack.`,
  },
  {
    id: 9,
    name: `Bandolier`,
  ...
  },
  {
    ...
    name: `Black Mask`,
    consequence_of: 18,
    description: `* Visit the Retinue to perform story event Strange Caravan (Lion Knight).
  ...
  },
  {
    ...
    name: `Bloodletting`,
    consequence_of: 4,
    description: `* Breathing a Vein - spend 1 resource and roll 1d10:
  ...
  },
  {
    ...
    name: `Bloodline`,
    consequence_of: 29,
    description: `Newborn survivors inherit the following from their parents:
  ...
  },
  {
    ...
    consequence_of: 2,
    survival_limit: 1,
    description: `*** Try to Heal - once this lantern year, roll 1d10:
  ...
  },
  {
    ...
    name: `Clan of Death`,
    consequence_of: 22,
    description: `The enduring strength of your clan passes through generations. All newborn survivors gain +1 accuracy, +1 strength, and +1 evasion.`,
  },
  {
    id: 16,
    name: `Cooking`,
    consequence_of: 32,
    survival_limit: 1,
    description: `* Culinary Inspiration - roll 1d10:
    1 - 2 Uninspired
  ...
  },
  {
    ...
    name: `Crimson Candy`,
    consequence_of: 33,
    description: `At the start of each showdown, each survivor gains the Manhunter's level in survival.
  ...
  },
  {
    ...
    consequence_of: 55,
    insanity_depart: 2,
    description: `* Light-Forging story event.
  ...
  },
  {
    ...
    name: `Drums`,
    consequence_of: 31,
    description: `* Bone Beats - roll 1d10:
  ...
  },
  {
    ...
    name: `Empire`,
    consequence_of: 13,
    description: `Newborn survivors are born with +1 permanent strength and the Pristine ability.
  ...
  },
  {
    ...
    name: `Face Painting`,
    consequence_of: 37,
    description: `* Battle Paint - roll 1d10:
  ...
  },
  {
    ...
    consequence_of: 29,
    survival_depart: 1,
    description: `Survivors nominated for Intimacy may give themselves a surname if they do not have one.
  ...
  },
  {
    ...
    description: `Once per settlement phase, if the returning survivors are victorious, gain 1 random basic resource.
  ...
  },
  {
    ...
    survival_limit: 1,
    description: `Once per showdown, you may select a card from the discard pile or wound stack and place it on top of the AI deck.`,
  },
  {
    id: 25,
    name: `Forbidden Dance`,
    consequence_of: 19,
    description: `* Fever Dance - roll 1d10:
  ...
  },
  {
    ...
    name: `Guidepost`,
    survival_depart: 1,
    description: `The soft glow of its light fills the survivors with a sense of security. Departing survivors gain +1 survival.
  ...
  },
  {
    ...
    consequence_of: 30,
    description: `The settlement embraces their protective feelings. All survivors gain the Overcharge survival action. Overcharge: If you have any +1 strength tokens, you may spend 1 survival and remove them all to give your next attack this round Devastating 1. Limit 1x/round.`,
  },
  {
    id: 28,
    name: `Heart Flute`,
    consequence_of: 25,
    description: `May only be used once per settlement phase.
  ...
  },
  {
    ...
    survival_limit: 1,
    survival_depart: 1,
    description: `The settlement accepts this nightmarish landscape as their home.`,
  },
  {
    id: 30,
    name: `Inner Lantern`,
    consequence_of: 31,
    description: `The settlement finds the light within. All survivors gain the Surge survival action.
  ...
  },
  {
    ...
    name: `Language`,
    survival_limit: 1,
    description: `All survivors gain the Encourage survival action.
  ...
  },
  {
    ...
    consequence_of: 4,
    survival_depart: 1,
    description: `Heat By agitating lanterns, a source of Heat becomes available to the settlement.`,
  },
  {
    id: 33,
    name: `Legless Ball`,
    consequence_of: 18,
    insanity_depart: 2,
    description: `Spend only 1 * here per settlement phase.
  ...
  },
  {
    ...
    name: `Momento Mori`,
    consequence_of: 40,
    description: `May be used once per settlement phase.
  ...
  },
  {
    ...
    consequence_of: 60,
    description: `* Train - lose 3 survival and roll 1d10:
  ...
  },
  {
    ...
    consequence_of: 30,
    survival_limit: 1,
    description: `* Gormchymy Stuff! - roll 1d10:
  ...
  },
  {
    ...
    name: `Partnership`,
    consequence_of: 29,
    description: `** Nominate two survivors. They pair off, and each gains the Partner ability. A survivor may be nominated for Partnership once per lifetime.
  ...
  },
  {
    ...
    name: `Petal Spiral`,
    consequence_of: 25,
    description: `* Trace Petals - roll 1d10:
  ...
  },
  {
    ...
    name: `Pictograph`,
    consequence_of: 37,
    description: `Crudely-drawn pictures guide the survivors' way home. Anytime during the hunt or showdown phase, a survivor may perform the Run Away story event.`,
  },
  {
    id: 41,
    name: `Pottery`,
    consequence_of: 51,
    survival_limit: 1,
    description: `If the settlement loses all its resources, you may select up to two resources and keep them.
  ...
  },
  {
    ...
    name: `Records`,
    consequence_of: 58,
    description: `** Knowledge - roll 1d10:
  ...
  },
  {
    ...
    consequence_of: 35,
    description: `* Train - spend 1 resource and roll 1d10:
  ...
  },
  {
    ...
    name: `Rubedo`,
    consequence_of: 14,
    description: `**** Shoot Self in Head Once this lantern year, roll 1d10:
  ...
  },
  {
    ...
    name: `Sacrifice`,
    consequence_of: 54,
    description: `Death Ritual - roll 1d10:
  ...
  },
  {
    ...
    name: `Saga`,
    consequence_of: 56,
    description: `A telling of the settlement's survival, set to a soft rhythmic beating of drums. All newborn survivors gain +2 hunt XP (roll on Age event), and +2 survival from knowing the epic.`,
  },
  {
    id: 48,
    name: `Sauna Shrine`,
    consequence_of: 27,
    description: `When survivors depart for a Nemesis encounter or special showdown, they gain +10 survival.
  ...
  },
  {
    ...
    name: `Scarification`,
    consequence_of: 30,
    description: `* Initiation - once per lifetime, gain +1 courage and roll the hit location die.
  ...
  },
  {
    ...
    name: `Scrap Smelting`,
    consequence_of: 32,
    description: `* Purification - roll 1d10:
    1 - 2 Nothing happens.
  ...
  },
  {
    ...
    consequence_of: 37,
    survival_limit: 1,
    description: `Silhouettes of sculptures cast strange, comforting shadows on the outskirts of your settlement.
  ...
  },
  {
    ...
    consequence_of: 30,
    description: `Departing survivors gain +2 survivoal when they depart for a Nemesis Encounter or a special Showdown.
  ...
  },
  {
    ...
    name: `Shadow Dancing`,
    consequence_of: 29,
    description: `You may only endeavor here if a survivor died during the last hunt or showdown.
  ...
  },
  {
    ...
    consequence_of: 30,
    survival_limit: 1,
    description: `* Perform Silk Surgery story event
  ...
  },
  {
    ...
    consequence_of: 19,
    description: `The survivors celebrate life by lifting their voices into the darkness. All non-deaf survivors add +1 to their roll results on the Overwhelming Darkness event.`,
  },
  {
    id: 57,
    name: `Stoic Statue`,
    consequence_of: 33,
    description: `* Worship the Monster You (this survivor) may not depart or endeavor again this settlement phase.
  ...
  },
  {
    ...
    consequence_of: 60,
    survival_limit: 1,
    description: `** Tale as Old as Time - roll 1d10:
  ...
  },
  {
    ...
    consequence_of: 30,
    description: `* If Black Harvest is not on the timeline, add story event Underground Sow (DBK).
  ...
  },
  {
    ...
    consequence_of: 31,
    survival_limit: 1,
    description: `When a survivor innovates, draw an additional 2 Innovation Cards to choose from.`,
  },
  {
    id: 61,
    name: `Ultimate Weapon`,
    survival_limit: 1,
    description: `When you defeat a monster, gain 1 monster resource of your choice from its resource deck.`,
  },
  {
    id: 62,
    name: `War Room`,
    consequence_of: 30,
    survival_limit: 1,
    description: `A dangerous room of plans and tools. Quarries cannot move off the hunt board. If the survivors would move backward on the hunt board, roll 1d10. On a 4+, they don't.
