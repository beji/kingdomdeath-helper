...
const fightingArts: IFightingArt[] = [
  ...
  {
    description:
      'Add Bard as a "Weapon Proficiency." Each showdown played gains 1 point in it. Add this number to rolls with any instrument. At Bardic Mastery (8+ points), each time a bard plays they also have a 50% chance of removing a Trait card, in addition to other instrument effects.',
    id: 5,
    name: 'Bard',
  },
  {
    description:
      '1x/showdown, you may spend an action to shove an adjacent obstacle terrain. If you do, move the terrain ahead of you until you finish moving. If you pass over a monster, it takes 1 wound. Survivors are pushed out of the way to the side. You are knocked down at the end of your move.',
    id: 6,
  ...
  {
    description:
      'Once per showdown, you may call forth shadowy tentacles to hold the monster in place. From now until your next action, the monster is held in place. Ignore all monster movement on attacks, reactions, traps, and survivor attacks until your next act.',
    id: 11,
  ...
  {
    description:
      'When a survivor adjacent to you is knocked down, you may spend 1 survival. If you do, they stand again and gain +1 survival from your words of encouragement. You cannot use this if you have a broken jaw.',
    id: 20,
    name: 'Defender',
  },
  {
  ...
  {
    description:
      'Ignore Parry when attempting to wound hit locations. (Attempt to wound these locations normally.) When a monster attacks you, roll 1d10. On a 6+, ignore 1 hit. Limit 1x/round.',
    id: 24,
    name: 'Fencing',
  },
  {
    description:
      'Once per showdown, you may select a card from the discard pile or wound stack and place it on top of the AI deck. Settlement receives +1 survival limit if this fighting art was not previously known.',
    id: 25,
  ...
  {
    description:
      '-(Understanding/3 round up) Insanity every time insanity should be gained. -(Understanding/3 round up) Brain Damage every time Brain Damage should be taken. Eliminates all disorders, cannot gain disorders.',
    id: 27,
    name: 'Hardened',
  },
  {
  ...
  {
    description:
      'You cannot lose or remove this fighting art. Gain +1 strength for each full red affinity you have. You cannot be nominated for Intimacy. You ignore Extreme Heat. At the start of your act, lose 1 survival.',
    id: 30,
    name: 'Hellfire',
  },
  {
  ...
  {
    description:
      'When you depart, gain +1 armor to all hit locations for each gear card in your grid with the "symbol" keyword. If you would roll on the severe injury table, roll on the Worm Trauma table on the other side of the Necromancer card instead (from Lion God cards).',
    id: 45,
    name: 'Necromancer',
  },
  {
  ...
  {
    description:
      'During the Hunt and Settlement phases, whenever you roll on a table, you may add +1 to the roll result. Does not include rolls may during a nemesis showdown (or any showdown).',
    id: 47,
    name: 'Otherworldly Luck',
  },
  {
    description:
      'The first time you gain a resource during a showdown, you may feed it to your phantom friend. If you do, archive the resource and gain +1 evasion token. Lose this token if you are deaf or become deaf.',
    id: 48,
    name: 'Phantom Friend',
  },
  {
  ...
  {
    description:
      'Whenever a random hunt event roll matches (a 1d10 roll) matches the number of the hunt event card square, the event revealer gains +1 understanding and +1 courage.',
    id: 54,
    name: 'Seasoned Hunter',
  },
  {
    description:
      'Gain 1 rank, or 0 if this is the first time gaining it. Rank 0 (no bonuses). Rank 1: You may spend an action while adjacent to another survivor to add 2 armor to one of their hit locations. Rank 2: While all of the armor in your grid is silk and all jewelry is amber, gain +2 evasion. Rank 3: During the aftermath, roll 1d10 for each other survivor that died during the showdown. On a 7+, you revive them.',
    id: 55,
    name: 'Silk Surgeon',
  },
  {
  ...
  {
    description:
      "Your body mysteriously absorbs light. At the start of each showdown, gain survival up to the settlement's Survival Limit. If you have any +1 Strength tokens, you may spend them all to perform the Surge survival action.",
    id: 58,
    name: 'Sun Eater',
  },
  {
    description:
      'You no longer cast a shadow and you never hesitate, ignore First Strike. On a Perfect Hit, your first wound attempt of the attack automatically succeeds and inflicts a critical wound (if available). If you die during the showdown, place a Shade Minion in the space you occupied.',
    id: 59,
  ...
  {
    description:
      'When your wound attempt on a hit location is a failure, you may put that hit location back on top of the deck instead of the discard pile. Limit, once per round.',
    id: 61,
    name: 'Tenacious',
  },
  {
  ...
  {
    description:
      'The hunting party may start the hunt phase 1 space closer to the monster. At the start of the showdown, all survivors gain +1 survival and up to +1 insanity (their option).',
    id: 65,
    name: 'Trailblazer',
  },
  {
  ...
  {
    description:
      'If you draw a Trap hit location, instead of being the first hit location resolved, place half (rounded up) of the hit locations drawn before the Trap, with the rest behind it. (E.g. resolve fully half of the hit locations before resolving the trap.)',
    id: 67,
    name: 'Trapfinder',
  },
  {
  ...
  {
    description:
      "If you have a whip and the monster is within 3 squares of you, you may choose to pull them to you. The monster's base will now touch yours. This is a free action once per round.",
    id: 75,
    name: 'Whipmaster',
  },
  {
