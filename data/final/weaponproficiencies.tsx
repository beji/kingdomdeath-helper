import { IWeaponProficiency } from "../../src/interfaces";
import { WeaponProficiency } from "../../src/interfaces/ItemEnums";

const weaponproficiencies: ReadonlyArray<IWeaponProficiency> = [
