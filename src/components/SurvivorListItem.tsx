...
interface ISurvivorListItemProps
    extends ISurvivorListItemOwnProps,
        ISurvivorListItemStateProps,
            ...
            return (
                <ItemWrapper>
                    ...
                    <Cell>
                        ...
                        {alive ? (
                            <FancyButton onClick={this.handleKillClick}>Kill</FancyButton>
                        ) : (
                            <FancyButton onClick={this.handleReviveClick}>Revive</FancyButton>
                        )}
