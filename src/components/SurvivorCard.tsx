...
const mapDispatchToProps = (
    dispatch: Dispatch<UpdateSurvivorAction | UpdateSurvivorNameAction>,
): ISurvivorCardDispatchProps => ({
                    ...
                    <NameWrapper>
                        ...
                        <SpecialSection>
                            <section>
                                ...
                                <Checkbox
                                    value={survivor.skipNextHunt}
                                    onChange={this.toggleBooleanStat.bind(this, 'skipNextHunt')}
                                />
                            </section>
                            <section>
                                <Label>Lifetime ReRoll</Label>
                                <Checkbox
                                    value={survivor.lifetimeReroll}
                                    onChange={this.toggleBooleanStat.bind(this, 'lifetimeReroll')}
                                />
                            </section>
                        </SpecialSection>
                    </NameWrapper>
                    <TextSection>
                        {survival && (
                            <SurvivorStat>
                                ...
                                <SurvivorDefenseStat
                                    id={id}
                                    statid={survival.stat}
                                    concatToDisplay={`/ ${this.props.survivalLimit}`}
                                />
                            </SurvivorStat>
                        )}
