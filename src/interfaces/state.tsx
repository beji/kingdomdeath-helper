...
import { IBaseStatLayer, IDefenseStatLayer, IDisorderListLayer, IFightingartListLayer, IGearListLayer, ISimpleLayer, ISpecialStatLayer, IWeaponProficiencyLayer } from "interfaces/layer";
